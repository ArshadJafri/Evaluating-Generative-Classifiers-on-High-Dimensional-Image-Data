...
def grayscale_benchmark():
    print("Loading data...", end="")
    # Load and prepare the data (passing both root_path and as_grayscale arguments)
    train_data, train_labels, test_data, test_labels = load_and_prepare_data(root_path='cifar-10-batches-py', as_grayscale=True)
    print("done.")
